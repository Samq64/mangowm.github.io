...
Regardless of your installation method, mangowm requires a Wayland-capable environment. If you are building from source, ensure you have the following dependencies:
...
If your distribution isn't listed, you can build mangowm from source. You will need to build `wlroots` and `scenefx` manually as well.
